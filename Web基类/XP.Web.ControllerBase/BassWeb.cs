...
namespace XP.Web.ControllerBase
{
    public class BassWeb : Controller
    {
        ...
        /// <param name="rq"></param>
        /// <returns></returns>
        public decimal? GetNullDecimal(string key, NameValueCollection rq = null)
        {
            decimal? Result = null;
            if (null == rq)
            {
        ...
        /// <param name="rq"></param>
        /// <returns></returns>
        public long? GetNullDt(string key, NameValueCollection rq = null)
        {
            long? Result = null;
            if (null == rq)
            {
            ...
            if (DateTime.TryParse(input, out tem))
            {
                Result = Util.GeneralTool.DateTime2UnixTimestamp(tem);
            }
        ...
        /// <param name="rq"></param>
        /// <returns></returns>
        public DateTime? GetNullDatetime(string key, NameValueCollection rq = null)
        {
        ...
        /// <summary>
        /// 获取一个可空长整数类型(BigInt,64位整数)的参数
        /// </summary>
        /// <param name="key"></param>
        /// <param name="rq"></param>
        /// <returns></returns>
        public long? GetNullLong(string key, NameValueCollection rq = null)
        {
            long? Result = null;
            if (null == rq)
            {
        ...
        public bool? GetNullBoolean(string key, NameValueCollection rq = null)
        {
            bool? Result = null;
            if (null == rq)
            {
